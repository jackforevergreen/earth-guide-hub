...
export class FirecrawlService {
  ...
  static async scrapePage(url: string): Promise<{ success: boolean; error?: string; data?: any }> {
    ...
    try {
      ...
      const scrapeResponse = await this.firecrawlApp.scrapeUrl(url, {
        ...
        includeTags: ['article', 'main', 'h1', 'h2', 'h3', 'p', 'img'],
      ...
      if (!scrapeResponse.success) {
        ...
        return { 
          success: false, 
          error: scrapeResponse.error || 'Failed to scrape page' 
        };
      }
