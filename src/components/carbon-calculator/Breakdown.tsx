...
import { Leaf, Zap, Car, Utensils, Home, TrendingDown, BarChart3, LogIn, Lightbulb, TreePine, Wind, Globe, Earth, HeartPulse, Trees, Sprout, SproutIcon } from "lucide-react";
...
const Breakdown = ({ surveyData, surveyEmissions }: BreakdownProps) => {
  ...
  return (
    ...
    >
      ...
      <motion.div variants={fadeUp}>
        <Card className="shadow-xl border-2 border-gray-200 hover:shadow-2xl transition-shadow">
          <CardHeader className="text-center bg-gray-100 pb-6 pt-6">
            ...
            <p className="text-2xl font-semibold text-gray-700">tons CO₂ per year</p>
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-lg font-semibold text-gray-900">Diet</span>
                    </div>
            ...
            <div className="border-t-2 border-gray-100 pt-8">
              ...
              <div className="max-w-3xl mx-auto">
                <p className="text-center text-lg text-gray-700 mb-6 font-medium">
                  Your footprint vs. Average American ({avgAmericanEmissions} tons CO₂/year)
                </p>
                ...
                {/* Comparison Message */}
                <div className={`p-6 rounded-lg text-center border-2 shadow-md ${
                  totalEmissions < avgAmericanEmissions
                    ? 'bg-gradient-to-r from-green-50 to-green-100 border-green-300'
                    : 'bg-gradient-to-r from-orange-50 to-orange-100 border-orange-300'
                }`}>
                  <p className={`text-xl font-bold mb-2 ${
                    totalEmissions < avgAmericanEmissions ? 'text-green-900' : 'text-orange-900'
                  }`}>
                    {totalEmissions < avgAmericanEmissions
                      ? `🎉 You're ${(100 - parseFloat(percentageOfAverage)).toFixed(0)}% below average!`
                      : `You're ${(parseFloat(percentageOfAverage) - 100).toFixed(0)}% above average`}
                  </p>
                  <p className={`text-sm ${
                    totalEmissions < avgAmericanEmissions ? 'text-green-700' : 'text-orange-700'
                  }`}>
                    {totalEmissions < avgAmericanEmissions
      ...
      <motion.div variants={fadeUp}>
        <Card className="shadow-xl border-2 border-gray-200 hover:shadow-2xl transition-shadow">
          <CardHeader className="text-center bg-gray-100 pb-6">
            ...
            <CardTitle className="text-3xl font-bold text-gray-900">Reduce Your Impact</CardTitle>
            <p className="text-gray-600 mt-2">Small changes can make a big difference</p>
          </CardHeader>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h4 className="text-xl font-bold text-blue-900">Transportation</h4>
                </div>
                <ul className="text-sm text-blue-900 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-0.5">•</span>
                    <span>Consider carpooling or using public transportation</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-0.5">•</span>
      ...
      >
        <Card className="shadow-2xl bg-gradient-to-br from-yellow-300 via-green-600 to-blue-400 hover:shadow-3xl transition-all border-0 overflow-hidden">
          <CardContent className="py-12 text-center">
            ...
            <h2 className="text-5xl font-extrabold mb-4 text-white">Take Action Today!</h2>
            <p className="text-xl mb-10 max-w-2xl mx-auto text-white">
              Build your legacy and leave a lasting impact by offsetting your carbon footprint.
            </p>
